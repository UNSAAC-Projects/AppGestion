...
{
    public partial class FrmPrincipalDirecAcademico : Form
    {

        //Constructor
        public FrmPrincipalDirecAcademico()
        {
            InitializeComponent();
        ...
        private void FrmPrincipalDirecAcademico_Load(object sender, EventArgs e)
        {
